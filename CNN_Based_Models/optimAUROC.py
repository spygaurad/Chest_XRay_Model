...
def train(trainloader, testloader, class_weights, classes, lr=1e-4, epoch_decay=2e-3, weight_decay=1e-5, margin=1.0, total_epochs=2, include_class_weights=False):

    def calculate_confusion_matrix():
        

    def calculate_metrics(test_true, test_pred, classes):
