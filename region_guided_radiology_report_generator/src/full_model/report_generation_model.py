...
binary_classifier_abnormal_path = '/home/wiseyak/saumya/Chest_XRay_Model/region_guided_radiology_report_generator/src/binary_classifier/binary_classifier_region_abnormal.py'
binary_classifier_selection_path = '/home/wiseyak/saumya/Chest_XRay_Model/region_guided_radiology_report_generator/src/binary_classifier/binary_classifier_region_selection.py'
object_detector_path = '/home/wiseyak/saumya/Chest_XRay_Model/region_guided_radiology_report_generator/src/object_detector/object_detector.py'
language_model_path = '/home/wiseyak/saumya/Chest_XRay_Model/region_guided_radiology_report_generator/src/language_model/language_model.py'

# Load the modules using importlib
binary_classifier_abnormal_module = importlib.util.spec_from_file_location('binary_classifier_region_abnormal', binary_classifier_abnormal_path)
binary_classifier_abnormal = importlib.util.module_from_spec(binary_classifier_abnormal_module)
binary_classifier_abnormal_module.loader.exec_module(binary_classifier_abnormal)

binary_classifier_selection_module = importlib.util.spec_from_file_location('binary_classifier_region_selection', binary_classifier_selection_path)
binary_classifier_selection = importlib.util.module_from_spec(binary_classifier_selection_module)
binary_classifier_selection_module.loader.exec_module(binary_classifier_selection)

object_detector_module = importlib.util.spec_from_file_location('object_detector', object_detector_path)
object_detector = importlib.util.module_from_spec(object_detector_module)
object_detector_module.loader.exec_module(object_detector)

language_model_module = importlib.util.spec_from_file_location('language_model', language_model_path)
language_model = importlib.util.module_from_spec(language_model_module)
language_model_module.loader.exec_module(language_model)
...
class ReportGenerationModel(nn.Module):
    ...
    def __init__(self, pretrain_without_lm_model=False):
        ...
        self.object_detector = object_detector.ObjectDetector(return_feature_vectors=True)
        ...
        self.binary_classifier_region_selection = binary_classifier_selection.BinaryClassifierRegionSelection()
        self.binary_classifier_region_abnormal = binary_classifier_abnormal.BinaryClassifierRegionAbnormal()
